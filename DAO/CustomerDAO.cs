...
namespace HotelManagementSystem.DAO
{
    public class CustomerDAO
    {
        ...
        public static Customer FindCustomersByName(string fullName)
        {
          
            Customer customer = null;

            SqlConnection conn = DBConnection.Connection.GetConnection();
            SqlCommand cmd = new SqlCommand("SELECT * FROM dbo.fn_FindtoCustomer(@full_name)", conn);
            cmd.Parameters.Add("@full_name", SqlDbType.VarChar).Value = fullName;
